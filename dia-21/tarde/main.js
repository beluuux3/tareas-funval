...
let estudiante = {
  nombre1: "Belen",
  edad1: 27,
  notas: { nota1: 45, nota2: 75, nota3: 95 },
};
...
let prom = ((nota1 + nota2 + nota3) / 3).toFixed(2);

let mensaje1 = `Hola estudiante ${nombre1}, con ${edad1}. Con tus notas: ${nota1}, ${nota2} y ${nota3}, tienes el promedio de ${prom}`;
alert(mensaje1);
...
let { nombre2, precio, ...rest } = objetito;

console.log(`La ${nombre2} tiene un precio de ${precio}
